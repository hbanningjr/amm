...
const Swap = () => {
  ...
  const getPrice = async () => {
    console.log("getPrice called", inputToken, outputToken);
    console.log("token1Balance", await amm.token1Balance());

    if (inputToken === "DAPPU") {
      const balance1 = await amm.token1Balance();
      const balance2 = await amm.token2Balance();
      console.log(
        "formatted balance1",
        ethers.utils.formatUnits(balance1, "ether"),
      );
      console.log(
        "formatted balance2",
